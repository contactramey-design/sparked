...
server.listen(PORT, () => {
  console.log(`Local API: http://localhost:${PORT} (config, setup-status, video-worker-health, process-homework, generate-adventure-video, create-checkout-session, download-ebook)`)
}).on('error', (err) => {
