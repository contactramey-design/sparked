 ...
 * Locale is applied via parent `window.__SPARKI_EMBED_LANG__` + iframe reload (see CanvaHtmlPractice),
 * not query params, so toggling language does not change the URL string or confuse routing.
 */
