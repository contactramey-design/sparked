...
function BigAgeCard({ title, subtitle, selected, onSelect, ariaLabel }: { title: string; subtitle: string; selected: boolean; onSelect: () => void; ariaLabel: string }) {
  return (
    <button
      type="button"
      onClick={onSelect}
...
export function HomeAgeBandsAscent() {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-3xl border border-teal-100/60 bg-ascent-warm px-6 py-10 md:px-12 md:py-14">
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,37%)_1fr] lg:gap-12">
          <div>
            <SectionHeading
          ...
          <div className="relative flex flex-wrap justify-center gap-3 sm:flex-nowrap sm:justify-between sm:gap-4 md:gap-6 lg:gap-8">
            <div className="mt-0 flex flex-col items-center gap-3 sm:mt-14 sm:items-end md:gap-4">
              <BigAgeCard
